...
| A8-6 | Aggregation benchmark at volume (RSK-04) | **ACR-45** | 🔄 draft PR — `ticket-45/aggregation-benchmark`, plan at `plans/plan_ticket_45.md`. Hypothesis **confirmed and acted on**: migration `015` indexes `inventory_lots`, RSK-04 **Resolved**, snapshot fallback **retired**, RSK-08 opened for `export_csv` | — |
