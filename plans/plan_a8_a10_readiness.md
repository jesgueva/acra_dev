...
| A8-7 | Subsystem diagram marking measurement points | **ACR-49** | ✅ done — `docs/architecture.md` "Measurement points" section maps `validation-run.sh`'s six stages (6a–6f) onto the component boundaries they cross, cross-referenced from the script. Docs-only | `ea5dec5` ([PR #52](https://github.com/jesgueva/acra_dev/pull/52)) |
